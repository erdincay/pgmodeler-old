...
{"ERR_PGMODELER_INSTIPODUPLIC", QObject::tr("O tipo de dado '%1' não pode ser atribuído pois o mesmo já existente na lista de tipos da função de agragação '%2'!")},
...
{"ERR_PGMODELER_ATROBJRELINV", QObject::tr("Um atributo não pode ser adicionado a um relacionamento personalizado, de generalização ou de dependência!")},
...
{"ERR_PGMODELER_ATRPERMISSAODUPLIC", QObject::tr("Já existe uma permissão sobre o objeto '%2' (%3) a qual possui um ou mais papéis iguais aos presentes na permissão a ser atribuída ao objeto!")},
...
{"ERR_PGMODELER_TIPOUSRAUTOREF", QObject::tr("O tipo '%1' não pode se auto-referenciar nos atributos 'elemento' ou 'tipo cópia' ou ser usado como tipo de dado de um atributo na configuração de tipo composto!")},
...
{"ERR_PARSERS_ATRIBBUFXMLVAZIO", QObject::tr("Atributo de buffer de código XML vazio ao parser!")},
